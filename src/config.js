...
export const klayTargetNetwork = process.env.REACT_APP_KLAYTN_TARGET_NETWORK;
export const klayTargetNetworkMsg = process.env.REACT_APP_KLAYTN_TARGET_NETWORK_MSG;
